...
def package_server():
	...
	shutil.copy(os.path.join(options.binary_dir, 'README.static.osx'), os.path.join(destdir, 'README'))
	...
	shutil.copy(os.path.join(os.path.join(options.binary_dir, 'murmurd'), os.path.join(destdir, 'murmurd')))
